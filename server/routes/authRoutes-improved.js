...
// Improved device info extraction for mobile support
const extractDeviceInfo = (req) => {
  const userAgent = req.headers['user-agent'] || '';
  
  // Better IP detection for mobile and proxies
...
// POST /api/auth/login - Improved for mobile
router.post("/login", async (req, res) => {
  try {
    const { username, password } = req.body;
    console.log("🔐 LOGIN ATTEMPT for:", username, "from IP:", req.headers['x-forwarded-for'] || req.connection.remoteAddress);
